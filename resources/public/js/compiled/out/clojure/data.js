...
return cljs.core.reduce.call(null,(function (result,p__28991){
...
var vec__28994 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__28994,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__28994,(1),null);
var ab = cljs.core.nth.call(null,vec__28994,(2),null);
...
var args28995 = [];
var len__17376__auto___28998 = arguments.length;
var i__17377__auto___28999 = (0);
while(true){
if((i__17377__auto___28999 < len__17376__auto___28998)){
args28995.push((arguments[i__17377__auto___28999]));

var G__29000 = (i__17377__auto___28999 + (1));
i__17377__auto___28999 = G__29000;
continue;
} else {
}
break;
...
var m__16974__auto__ = (clojure.data.equality_partition[goog.typeOf(x__16973__auto__)]);
if(!((m__16974__auto__ == null))){
return m__16974__auto__.call(null,x);
} else {
var m__16974__auto____$1 = (clojure.data.equality_partition["_"]);
...
var x__16973__auto__ = (((a == null))?null:a);
var m__16974__auto__ = (clojure.data.diff_similar[goog.typeOf(x__16973__auto__)]);
if(!((m__16974__auto__ == null))){
return m__16974__auto__.call(null,a,b);
} else {
var m__16974__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__16974__auto____$1 == null))){
return m__16974__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__29005 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__29005) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1444761115253